...
#Global Variables
#################
set DESIGN_NAME "fpu"    ;#  The name of the design
set OUTPUTS_DIR ../outputs/
set SCRIPTS ../scripts/
set DESIGN_STYLE "hier" ; #hier or flat
set PHYSICAL_HIERARCHY_LEVEL "top" ; #bottom or top
set DC_BLOCK_ABSTRACTION_DESIGNS "null"
set DDC_HIER_DESIGNS "fpu_add fpu_mul"
set UPF_MODE golden
...
#RTL Variables
##################################
set opensparc "/home1/14_nmts/14_nmts/references/opensparc/opensparc/"
...
set compile_ultra_cmd "compile_ultra -gate_clock -scan -gate_clock"
